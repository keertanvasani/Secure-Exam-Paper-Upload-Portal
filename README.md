...
Server verifies password using SHA-256 + salt
OTP is sent via Twilio SMS
User submits OTP
OTP is verified via Twilio Verify API
Secure session is created upon success
🔐 Encryption Workflow
Upload (Exam Controller)
Generate RSA-2048 key pair
Generate random AES-256 key
Encrypt exam paper using AES-256-GCM
Encrypt AES key using RSA public key
Digitally sign encrypted data using RSA private key
Encode encrypted content using Base64
Store encrypted data and metadata in database
Download (Faculty / Controller)
Retrieve encrypted data from database
Decode Base64 content
Decrypt AES key using RSA private key
Decrypt exam paper using AES-256-GCM
Verify digital signature
Provide decrypted file to authorized user
